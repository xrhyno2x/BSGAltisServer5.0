...
switch (_mode) do {
    ...
    case 2: {
        ...
        switch (_side) do {
            ...
            case east: {_query = format ["UPDATE players SET reb_licenses='%1' WHERE pid='%2'",_value,_uid];};
        };
    };
    ...
    case 3: {
        ...
        switch (_side) do {
            ...
            case east: {_query = format ["UPDATE players SET reb_gear='%1' WHERE pid='%2'",_value,_uid];};
        };
    };
